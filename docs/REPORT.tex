...
\arxiv{2603.29866}) and the L2D line of Okati, De \& G\'omez-Rodr\'iguez (NeurIPS 2021,
\arxiv{2103.08902}) and Mozannar \& Sontag (ICML 2020, \arxiv{2006.01862}) have, to our knowledge,
...
is loose terminology. This matters concretely. The single-human accuracy ceiling is the volunteer
...
only the rejector on top of its embeddings. This is deliberate. Co-training would give each L2D arm
...
HCT-1 reports 28--44\% cost savings on its own datasets. That is a property of those datasets, not a
...
\begin{itemize}
  ...
  \item \textbf{Reproducibility.} The code and frozen artifacts needed to reproduce this report's
    figure and table are released, and regeneration is deterministic. The one-off backbone training
